...
typedef struct _idl_structure  {   /* Structure definition: */
  ...
  UCHAR contains_string;	/* TRUE if structure contains strings, and
				   FALSE otherwise. This is computed by
				   align_structure() along with the
				   offsets and length. */
...
#define IDL_VENDOR_COMPANY "ITT"
#define IDL_VENDOR_COMPANY_LC "itt"
#define IDL_VENDOR_NAME "ITT Visual Information Solutions"
 ...
 */
#define IDL_VERSION_STRING "7.1"
#define IDL_VERSION_STRING_COPY "7.1"
#define IDL_VERSION_STRING_NOSUBMINOR "7.1"
...
extern IDL_HEAP_VPTR IDL_CDECL IDL_HeapVarNew(int hvid_type, IDL_VPTR
        value, int no_copy, int msg_action);
